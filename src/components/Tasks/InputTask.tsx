...
export default function InputTask() {
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="w-full md:h-[4.2rem] ">
                <input
                    type="text"
                    className="mr-3 mt-1 h-12 w-full outline-none  placeholder:text-VeryDarkGrayishBlue dark:bg-inherit dark:text-darkBlueHover md:h-14"
